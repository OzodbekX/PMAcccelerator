...
const SearchBar: React.FC<SearchBarProps> = ({ onSearch }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex w-full h-screen flex-col items-center bg-gray-50 pt-5">
            <div className="w-full max-w-sm overflow-hidden rounded-xl bg-white p-5 shadow-sm">
                <div className="flex overflow-hidden rounded-md bg-gray-600 focus:outline focus:outline-gray-500">
                    ...
                    <button className="bg-gray-200 px-3.5 text-white duration-150 hover:bg-gray-600">
